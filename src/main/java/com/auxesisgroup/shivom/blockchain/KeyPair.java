package com.auxesisgroup.shivom.blockchain;
...
public class KeyPair {
	...
	public Response getCredentials() {
		...
		try {
			...
			// return res;
			// }
			com.auxesisgroup.shivom.entity.Keypair keyPairObj = new com.auxesisgroup.shivom.entity.Keypair(null, null,
					address, publicKeyHex, privateKeyHex, null);
